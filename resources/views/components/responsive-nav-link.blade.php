...
$classes = ($active ?? false)
            ...
            : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-text-600 hover:text-background-800 hover:bg-background-50 hover:border-background-300 focus:outline-none focus:text-background-800 focus:bg-background-50 focus:border-background-300 transition duration-150 ease-in-out';
@endphp
