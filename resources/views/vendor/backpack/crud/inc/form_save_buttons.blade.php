<div class="saveActions form-group my-3">
    @if(isset($saveAction['active']) && !is_null($saveAction['active']['value']))
        ...
        @if(empty($saveAction['options']))
            <button type="submit" class="btn btn-success text-text-50">
        ...
        @else
            <div class="btn-group" role="group">
                ...
                <button type="button" class="bpSaveButtonsGroup btn btn-success text-text-50 dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" data-bs-toggle="dropdown" aria-expanded="false">
